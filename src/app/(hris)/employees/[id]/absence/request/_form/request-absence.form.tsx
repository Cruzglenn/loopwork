...
export function RequestAbsenceForm({ employeeId, dateFormat }: { employeeId: CUID; dateFormat: string }) {
  ...
  const handleSuccess = () => {
    toast(ABSENCE_TOASTS.REQUEST);
    router.push(HRIS_ROUTES.employees.absence.base(employeeId));
  };

...
import { cn, type CUID, HRIS_ROUTES, parseString, type OrderBy, type PropsWithClassName } from '@/shared';
...
import { EmployeeEquipmentBulkActions } from './employee-equipment-bulk-actions';
...
export function EmployeeEquipmentGridList({
  equipments,
  categories,
  className,
  navigationEnabled,
  ...
  const filteredActions = actions.filter((action) => action === 'assign');
